...
import static mattsturgill.peoplemonfinal.Constants.Constants.radiusInMeters;
...
public class MapPageView extends RelativeLayout implements OnMapReadyCallback,
    ...
    public boolean onMarkerClick(final Marker marker) {
        ...
        restClient.getApiService().catchUser(marker.getTitle(), radiusInMeters).enqueue(new Callback<Void>() {
            @Override
    ...
    public void checkForNearby() {
        ...
        restClient.getApiService().nearBy(radiusInMeters).enqueue(new Callback<User[]>() {
            @Override
